            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        <li class="breadcrumb-item"><a class="link-fx" href="<?= base_url() ?>petugas/janji_labo">Janji Labo</a></li>
            ...
            <div class="block-content block-content-full">
                <div class="row push">
                    <div class="col-lg-12 col-xl-12">
                        <form action="<?= base_url() ?>petugas/kf" method="POST">
                            ...
                            <div class="form-group">
                                <label for="example-text-input">Jam datang</label>
                                <?php
                                if ($janji['status'] == 'done') {
                                    echo "<input type='time' class='form-control form-control-alt' id='example-text-input' name='jam_datang' value='" . $janji['jam_datang'] . "' readonly>";
                                } else {
                                    echo "<input type='time' class='form-control form-control-alt' id='example-text-input' name='jam_datang' required>
                                    <small class='form-text text-danger'>*Jam Kedatangan Pasien Wajib di Isi</small>
                                    ";
                                }
                                ?>
                            </div>
                            <div class="form-group">
                                <label for="example-text-input">Jam Akhir</label>
                                <?php
                                if ($janji['status'] == 'done') {
                                    echo "<input type='time' class='form-control form-control-alt' id='example-text-input' name='jam_akhir' value='" . $janji['jam_akhir'] . "' readonly>";
                                } else {
                                    echo "<input type='time' class='form-control form-control-alt' id='example-text-input' name='jam_akhir' required>
                                    <small class='form-text text-danger'>*Jam Kedatangan Pasien Wajib di Isi</small>
                                    ";
                                }
                                ?>
                            ...
                            <div class="form-group">
                                <?php
                                if ($janji['status'] == 'done') {
                                    echo "<a href='" . base_url() . "petugas/selesai_janji/" . $janji['id_janji'] . "' class='btn btn-primary' data-toggle='click-ripple' onclick='return confirm('Apakah anda yakin?')'>Selesai</a>
                                    ...
                                    <a href='" . base_url() . "petugas/tolak/" . $janji['id_janji'] . "' class='btn btn-danger' data-toggle='click-ripple' onclick='return confirm('Apakah anda yakin?')'>Tolak Janji</a>
                                    ";
                                }
                                ?>
                            </div>
        ...
        <div class="block">
            ...
            <div class="block-content block-content-full">
                <div class="row push">
                    <div class="col-lg-12 col-xl-12">
                        <div class="form-group">
                            <p>Telp Pasien: <?= $janji['telp']; ?></p>
                            <p>Email Pasien : <?= $janji['email']; ?></p>
