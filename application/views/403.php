            ...
            <div class="hero">
                <div class="hero-inner text-center">
                    <div class="content content-full bg-white overflow-hidden">
                        <div class="py-4">
                            <!-- Error Header -->
                            <h1 class="display-1 text-flat invisible" data-toggle="appear" data-class="animated bounceIn">403</h1>
                            <h2 class="h3 font-w300 text-muted invisible mb-5" data-toggle="appear" data-class="animated fadeInUp">No Acces</h2>
                            <!-- END Error Header -->
                        </div>
                    </div>
                    <div class="content content-full font-size-sm text-muted">
                        ...
                        <a class="link-fx" href="<?= base_url() ?>">Go Back to Dashboard</a>
                        <!-- END Error Footer -->
                    </div>
                </div>
            </div>
