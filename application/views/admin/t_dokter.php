        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill h3 my-2">
                    Tambah Dokter <small class="d-block d-sm-inline-block mt-2 mt-sm-0 font-size-base font-w400 text-muted"></small>
                </h1>
    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-content block-content-full">
                <form action="<?= base_url() ?>admin/createDokter" method="POST" enctype="multipart/form-data" novalidate>
                    <div class="row push">
                        <div class="col-lg-12 col-xl-12">
                            <div class="form-group">
                                <label for="example-text-input">Nama Dokter</label>
                                <input type="text" class="form-control form-control-alt" id="example-text-input" name="nama_dokter" required>
                                <small class="form-text text-danger"><?= form_error('nama_dokter'); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="example-text-input">Spesialis</label>
                                <input type="text" class="form-control form-control-alt" id="example-text-input" name="spesialis" value="Dokter Spesialis " required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="informasi_dokter" class="form-control form-control-alt" rows="4" required></textarea>
                                <small class="form-text text-danger"><?= form_error('informasi_dokter'); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="example-email-input">Jam Operasional</label>
                                <textarea id="js-ckeditor" name="jam_operasional"><ul>
                                            <li class="text-muted">Senin - Selasa : 12.00 WIB - 15.00 WIB</li>
                                            <li class="text-muted">Kamis - Jumat : 15.00 WIB - 18.00 WIB</li>
                                            <li class="text-muted">Sabtu : 07.00 WIB - 09.00 WIB</li>
                                        </ul></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="example-file-input" name="image_dokter" required>
