        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill h3 my-2">
                    Tambah Kategori Test <small class="d-block d-sm-inline-block mt-2 mt-sm-0 font-size-base font-w400 text-muted"></small>
                </h1>
    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-content block-content-full">
                <form action="<?= base_url() ?>admin/insertKT" method="POST" enctype="multipart/form-data" novalidate>
                    <div class="row push">
                        <div class="col-lg-12 col-xl-12">
                            <div class="form-group">
                                <label for="example-text-input">Nama Kategori Test</label>
                                <input type="text" class="form-control form-control-alt" name="nama_kategori" required>
